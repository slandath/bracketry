...
describe("Borders", () => {
  it("applies rootBorderColor to all borders without color specified", () => {
    ...
    cy.get(`.button-up`).should(
      "have.css",
      "border-bottom-color",
      "rgb(1, 1, 1)",
    );
    cy.get(`.button-down`).should(
      "have.css",
      "border-top-color",
      "rgb(1, 1, 1)",
    );
    cy.get(`.navigation-button.left`).should(
      "have.css",
      "border-right-color",
      "rgb(1, 1, 1)",
    );
    cy.get(`.navigation-button.right`).should(
      "have.css",
      "border-left-color",
      "rgb(1, 1, 1)",
    );
  ...
  it("applies subordinate border colors instead of rootBorderColor when such colors are provided", () => {
    ...
    cy.get(`.match-body.live`)
      .eq(0)
      .should("have.css", "border-color", "rgb(5, 5, 5)");
  });
});
